...
const page = () => {
    ...
    <div className="flex flex-col lg:flex-row min-h-screen">
        ...
        <aside className="w-full lg:w-64 bg-white border-r border-slate-200 p-6 flex flex-col justify-between">
            <div>
                <h1 className="text-xl font-black text-indigo-600 tracking-tighter mb-10">Japanese<span className="text-slate-400">Trainer</span></h1>
